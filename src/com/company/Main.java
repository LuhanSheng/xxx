...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        //准备用户数据
        String username = "xxxx";String password= "xxxxx";String studentname= "LuhanSheng";String subject="math";
        User user=new User(username,password,studentname,subject);
        Connection con=db.getConnection();        //数据库链接
...
//        p.executeUpdate();
        ...
        while(resultSet.next()){ //遍历结果集，取出数据
            ...
            System.out.print("账号："+student_username+" ");//输出数据
